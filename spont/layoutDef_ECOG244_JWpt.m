...
for iE=1:nE
    ind = ch(iE);
    microdrive.electrodes(ind).position.row = row(iE);
    microdrive.electrodes(ind).position.col = col(iE);
    microdrive.electrodes(ind).position.x   = pos_x(iE);
    microdrive.electrodes(ind).position.y   = pos_y(iE);
end
